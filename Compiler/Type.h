...
class Type {
 ...
 public:
  ...
  static pair<bool,bool> isSubType(Type* type1, Type* type2);
  static pair<bool,bool> isSubType(Type* type1, TypeTag t2);
  static pair<bool,bool> isSubType(TypeTag t1, TypeTag t2);
